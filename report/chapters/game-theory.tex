...
In games with ties, the argument presented in \autoref{th:ptbre-subset-pte} does not hold anymore.
Indeed, \autoref{tab:ties-pte-ne-ptbre} shows that PTE and PTBRE are intersecting.
