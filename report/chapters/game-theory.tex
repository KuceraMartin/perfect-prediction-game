...
All the \enquote{subset} relations from the previous section still hold, since symmetric games are a subset of general games.
...
Thus, the venn diagram from \autoref{fig:venn-general-without-ties} remains almost unchanged.
