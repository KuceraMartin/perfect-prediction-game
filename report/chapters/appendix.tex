...
\begin{table}
	\caption{
		...
		Profiles (A, A), (A, C), (B, B), and (C, A) are PTOPE but only (B, B) is a strict PTBRE.
	}
...
\begin{table}
	\caption{
		IR $\not\subseteq$ PTBRE.
		Profiles (B, B), (B, C), (C, B), and (C, C) are individually rational but only (B, B) is a perfectly transparent optimal profile equilibrium.
	}
